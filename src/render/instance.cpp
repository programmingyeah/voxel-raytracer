...
bool Instance::isDeviceSuitable(VkPhysicalDevice device) {
    ...
    if (extensionsSupported) {
        ...
        std::cerr << "Unsupported extension included" << std::endl;
    }
...
void Instance::pickPhysicalDevice() {
    ...
    if (deviceCount == 0) throw std::runtime_error("No GPU with Vulkan support found!");
...
void Instance::createLogicalDevice() {
    ...
    VkPhysicalDeviceSwapchainMaintenance1FeaturesEXT swapchainMaintFeatures{};
    swapchainMaintFeatures.sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SWAPCHAIN_MAINTENANCE_1_FEATURES_EXT;
    swapchainMaintFeatures.swapchainMaintenance1 = true;

    VkPhysicalDeviceFeatures deviceFeatures{};
    VkDeviceCreateInfo createInfo{};
    createInfo.sType = VK_STRUCTURE_TYPE_DEVICE_CREATE_INFO;
    createInfo.pNext = &swapchainMaintFeatures;
...
VkImageView Instance::createImageView(VkImage image, VkFormat format, VkImageAspectFlags aspectFlags) {
...
VkCommandBuffer Instance::beginSingleTimeCommands(CommandPool pool) {
...
void Instance::endSingleTimeCommands(CommandPool pool, VkCommandBuffer commandBuffer) {
    ...
    vkFreeCommandBuffers(_device, pool.getHandle(), 1, &commandBuffer);
}
