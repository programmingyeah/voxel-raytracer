...
//ma in
void Swapchain::init(Instance* instance, GLFWwindow* window) {
    _window = window;
...
void Swapchain::createSwapchain(Instance* instance) {
    ...
    if (vkCreateSwapchainKHR(instance->device(), &createInfo, nullptr, &_swapchain) != VK_SUCCESS) {
        throw std::runtime_error("failed to create swap chain!");
    }

    vkGetSwapchainImagesKHR(instance->device(), _swapchain, &imageCount, nullptr);
    swapChainImages.resize(imageCount);
    vkGetSwapchainImagesKHR(instance->device(), _swapchain, &imageCount, swapChainImages.data());
...
void Swapchain::cleanup(Instance* instance) {
    if (_swapchain != VK_NULL_HANDLE) {
        vkDestroySwapchainKHR(instance->device(), _swapchain, nullptr);
